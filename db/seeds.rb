...
Product.create(name: 'Gold button Cardigan, Black', category: "Women's Casualwear", price: 49.99, quantity: 9)
...
Product.create(name: 'Fine Stripe Short Sleeve Shirt, Green', category: "Men's Casualwear", old_price: 49.99, price: 39.99, quantity: 3)
...
Product.create(name: 'Mid Twist Cut-Out Dress, Pink', category: "Women's Formalwear", price: 540, quantity: 15)
